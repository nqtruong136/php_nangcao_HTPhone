...
/**
 * Hàm này nhận vào một mảng các sản phẩm và hiển thị chúng theo bố cục slider nhóm.
  ...
  echo <<<HTML
    <div class="swiper-slide">
        <div class="card-grid-style-1">
            <div class="image-box">
                <a href="?url=Blog/details/{$blog['MaBlog']}">
                    <img src="assets/imgs/blog/{$blog['AnhDaiDien']}" alt="Ecom">
                </a>
            </div>
            <a class="tag-dot font-xs" href="?url=Blog/category/{$blog['TheLoai']}">{$blog['TheLoai']}</a>
            <a class="color-gray-1100" href="?url=Blog/details/{$blog['MaBlog']}">
                <h4>{$blog['TieuDe']}</h4>
            </a>
            <div class="mt-20">
                <span class="color-gray-500 font-xs mr-30">{$formattedDate}</span>
                <span class="color-gray-500 font-xs">{$blog['ThoiGianDoc']}<span> Mins read</span></span>
            </div>
        </div>
    </div>
HTML;
...
function render_product_card_best_seller($product)
{
          ...
          <div class="card-grid-style-3 hover-show hurry-up">
            <div class="card-grid-inner">
              ...
              <div class="box-count box-count-square">
                <div class="deals-countdown" data-countdown="2025/08/07 00:30:00"></div>
              </div>
    ...
    <div class="container">
      ...
      <div class="tab-content">
        <div class="tab-pane fade active show" id="tab-2-all" role="tabpanel" aria-labelledby="tab-2-all">
          <div class="list-products-5">
            <?php
            foreach ($data['data_trend_week'] as $product) {
              render_product_card_best_seller($product);
            }
            ?>
            <div class="card-grid-style-3">
              <div class="card-grid-inner">
        ...
        <div class="col-lg-8">
          ...
          <div class="box-swiper">
            <div class="swiper-container swiper-group-1">
              <div class="swiper-wrapper pt-5">
                <?php
                render_top_selling_slider($data['data_topselling']);
                ?>
